 ...
 *     → "a8f93b1d0d3b8f..."
 */
async function hashClientSignature(data) {
 ...
 * }
 */
export async function registerUser(username, email, password, secretKey) {
 ...
 * }
 */
export async function loginUser(username, password, secretKey) {
